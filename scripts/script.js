  ...
  let init = {
    ...
    .then( data => {
      ...
      for(let i = 0;i < produtos.length; i++)
      {
          div.innerHTML =
          // div.innerHTML + 
          // "<p class='inner' id="+i+">"+ produtos[i].nome +"</p>" + "<br>";
          ...
          <div class="price__wrapper">
            <div class="price__firstson">
              ...
              <div>
              <a><img width="30px" src="http://placekitten.com/1600/900"></a>
              <a><img width="30px" src="http://placekitten.com/1600/900"></a>
              </div>
            </div>
    ...
    // for(let i = 0;i < produtos.length; i++)
    // {
    //     div.innerHTML = div.innerHTML + "<p class='inner' id="+i+">"+ produtos[i].nome +"</p>" + "<br>";
    // }
  }